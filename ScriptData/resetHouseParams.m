% Function for resetting residential unit parameters

% Copyright 2023 - 2024 The MathWorks, Inc.

function resetHouseParams(rUnit)
resUnitParams.lenHouse = rUnit.dimResUnit(1);
resUnitParams.widHouse = rUnit.dimResUnit(2);
resUnitParams.htHouse = rUnit.dimResUnit(3);
...
resUnitParams.tHouseSet_degC = 18; % House set temperature
...
resUnitParams.radiator.lenPipe = 1.5; % length of radiator pipe [m]
resUnitParams.radiator.diaPipe = 0.1; % Hydraulic diameter of radiator pipe [m]
resUnitParams.radiator.extAreaPipe = 1.5; % Internal surface area of the radiator [m^2]
...
% calculated features of the room 
